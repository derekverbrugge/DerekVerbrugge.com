...
define('CONTACTFORM_TO_ADDRESS', 'derekverbrugge@gmail.com');
define('CONTACTFORM_TO_NAME', 'Derek Verbrugge');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'derekverbrugge@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'qyaukffubcerqfmt');

// The reCAPTCHA credentials for your site. You can get these at https://www.google.com/recaptcha/admin
define('CONTACTFORM_RECAPTCHA_SITE_KEY', '6Levw8wZAAAAAHfd-0Biv-xu5hBkA1Btj5zj60uv');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', '6Levw8wZAAAAALRZKyqa7pUerkE0E-0ZdnEKTRDy');
